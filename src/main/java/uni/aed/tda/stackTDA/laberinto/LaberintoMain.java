package uni.aed.tda.stackTDA.laberinto;
...
public class LaberintoMain{
     ...
     */
        ...
        private static Laberinto obtenLaberintoBase() {
        CeldaDelLaberinto celdas[][] = new CeldaDelLaberinto[N][N];
    ...
    public static Laberinto obtenLaberintoBase1() {
        CeldaDelLaberinto celdas[][] = new CeldaDelLaberinto[N][N];
        for(int i = 0;i<celdas.length ;++i) 
            for(int j =0;j<celdas[0].length;++j) 
                celdas[i][j] = new CeldaDelLaberinto(i, j) ;        
        
        celdas[0][0].derribaPared(CeldaDelLaberinto.ESTE_O) ;        
        celdas[0][1].derribaPared(CeldaDelLaberinto.OESTE_O) ;
        celdas[0][1].derribaPared(CeldaDelLaberinto.SUR_O) ;        
        celdas[0][2].derribaPared(CeldaDelLaberinto.SUR_O) ;
        celdas[0][2].derribaPared(CeldaDelLaberinto.ESTE_O) ;        
        celdas[0][3].derribaPared(CeldaDelLaberinto.NORTE_O) ; 
        celdas[0][3].derribaPared(CeldaDelLaberinto.OESTE_O) ;
        celdas[0][3].derribaPared(CeldaDelLaberinto.ESTE_O) ;
        celdas[0][4].derribaPared(CeldaDelLaberinto.OESTE_O) ;
        celdas[0][4].derribaPared(CeldaDelLaberinto.SUR_O) ;
        //=====================================================================
        celdas[1][0].derribaPared(CeldaDelLaberinto.SUR_O) ;
        celdas[1][0].derribaPared(CeldaDelLaberinto.ESTE_O) ;        
        celdas[1][1].derribaPared(CeldaDelLaberinto.OESTE_O) ;
        celdas[1][1].derribaPared(CeldaDelLaberinto.NORTE_O) ;
        celdas[1][1].derribaPared(CeldaDelLaberinto.SUR_O) ;        
        celdas[1][2].derribaPared(CeldaDelLaberinto.NORTE_O) ;
        celdas[1][2].derribaPared(CeldaDelLaberinto.SUR_O) ;        
        celdas[1][3].derribaPared(CeldaDelLaberinto.SUR_O) ;
        celdas[1][4].derribaPared(CeldaDelLaberinto.NORTE_O) ;
        //=====================================================================
        celdas[2][0].derribaPared(CeldaDelLaberinto.NORTE_O) ;        
        celdas[2][1].derribaPared(CeldaDelLaberinto.NORTE_O) ;
        celdas[2][1].derribaPared(CeldaDelLaberinto.ESTE_O) ;                
        celdas[2][2].derribaPared(CeldaDelLaberinto.NORTE_O) ;
        celdas[2][2].derribaPared(CeldaDelLaberinto.SUR_O) ;
        celdas[2][2].derribaPared(CeldaDelLaberinto.OESTE_O) ;        
        celdas[2][3].derribaPared(CeldaDelLaberinto.NORTE_O) ; 
        celdas[2][3].derribaPared(CeldaDelLaberinto.ESTE_O) ; 
        celdas[2][4].derribaPared(CeldaDelLaberinto.OESTE_O) ;
        celdas[2][4].derribaPared(CeldaDelLaberinto.ESTE_O) ;
        celdas[2][4].derribaPared(CeldaDelLaberinto.SUR_O) ;
        //=====================================================================
        celdas[3][0].derribaPared(CeldaDelLaberinto.ESTE_O) ;
        celdas[3][0].derribaPared(CeldaDelLaberinto.SUR_O) ;        
        celdas[3][1].derribaPared(CeldaDelLaberinto.OESTE_O) ;
        celdas[3][1].derribaPared(CeldaDelLaberinto.ESTE_O) ;               
        celdas[3][2].derribaPared(CeldaDelLaberinto.NORTE_O) ;
        celdas[3][2].derribaPared(CeldaDelLaberinto.OESTE_O) ;        
        celdas[3][3].derribaPared(CeldaDelLaberinto.ESTE_O) ;
        celdas[3][3].derribaPared(CeldaDelLaberinto.SUR_O) ;         
        celdas[3][4].derribaPared(CeldaDelLaberinto.NORTE_O) ;
        celdas[3][4].derribaPared(CeldaDelLaberinto.OESTE_O) ;
        //=====================================================================
        celdas[4][0].derribaPared(CeldaDelLaberinto.NORTE_O) ;
        celdas[4][0].derribaPared(CeldaDelLaberinto.ESTE_O) ;
        celdas[4][1].derribaPared(CeldaDelLaberinto.NORTE_O) ;
        celdas[4][1].derribaPared(CeldaDelLaberinto.SUR_O) ;
        celdas[4][2].derribaPared(CeldaDelLaberinto.NORTE_O) ;
        celdas[4][2].derribaPared(CeldaDelLaberinto.SUR_O) ;
        celdas[4][3].derribaPared(CeldaDelLaberinto.SUR_O) ;
        celdas[4][4].derribaPared(CeldaDelLaberinto.NORTE_O) ;
        celdas[4][4].derribaPared(CeldaDelLaberinto.SUR_O) ;        
        celdas[4][4].derribaPared(CeldaDelLaberinto.ESTE_O) ;        
        
        CeldaDelLaberinto entrada = celdas[0][3];
        CeldaDelLaberinto salida = celdas[2][4];
        Laberinto laberinto = new Laberinto(celdas,entrada,salida) ;
        //Laberinto laberinto = new Laberinto(N,N,entrada,salida) ;
        return laberinto;
    }
    private void solveRandom(Laberinto laberinto) {
        ...
        while (actual != salida) {            
            ...
            if (actual != null){
                ...
                System.out.println("Ruta de solución No encontrada");
        }
